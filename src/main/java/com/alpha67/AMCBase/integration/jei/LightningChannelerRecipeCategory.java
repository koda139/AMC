...
public class LightningChannelerRecipeCategory implements IRecipeCategory<LightningChannelerRecipe> {
    public final static ResourceLocation UID = new ResourceLocation(AMCBase.MOD_ID, "lightning");
    public final static ResourceLocation TEXTURE =
            new ResourceLocation(AMCBase.MOD_ID, "textures/gui/lightning_channeler_gui.png");
