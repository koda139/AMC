...
public class StoneMarketScreen extends ContainerScreen<StoneMarketContainer> {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.renderBackground(matrixStack);
        ...
        int time = this.getContainer().getStoneTime();


        this.font.drawString(matrixStack, "money : " + money, this.guiLeft + 17, this.guiTop + 40, -16737997);
        this.font.drawString(matrixStack, "stone price: " + stone, this.guiLeft + 17, this.guiTop + 23, -16750900);
        ...
        this.addButton(new Button(this.guiLeft + 119, this.guiTop + 63, 35, 18, name, e -> {
            if (true) {
                AMCBase.PACKET_HANDLER.sendToServer(new ButtonMarket(this.pos, 0));
            }
        }));
