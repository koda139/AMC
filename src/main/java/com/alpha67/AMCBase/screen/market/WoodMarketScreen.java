...
public class WoodMarketScreen extends ContainerScreen<WoodMarketContainer> {
    ...
    private final WoodMarketTile generator;
    ...
    public WoodMarketScreen(WoodMarketContainer screenContainer, PlayerInventory inv, ITextComponent titleIn) {
    ...
    public void render(MatrixStack matrixStack, int mouseX, int mouseY, float partialTicks) {
      ...
      this.renderBackground(matrixStack);
        ...
        WoodMarketTile BlockEntity = (WoodMarketTile) world.getTileEntity(pos);

        double money = this.getContainer().getMoneyContainer();
        double Wood = this.getContainer().getWoodPrice();
        double maxPrice = this.getContainer().getMaxPrice();

        int time = this.getContainer().getWoodTime();


        this.font.drawString(matrixStack, "money : " + money, this.guiLeft + 17, this.guiTop + 40, -16737997);
        this.font.drawString(matrixStack, "wood price: " + Wood, this.guiLeft + 17, this.guiTop + 23, -16750900);
