...
public class GoldMarketContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;
    public BlockPos BlockPos;

    public final GoldMarketTile generator;

    protected GoldMarketTile te;
    ...
    public GoldMarketContainer(int windowId, World world, BlockPos pos,
                               PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.GOLD_MARKET_CONTAINER.get(), windowId);
        this.tileEntity = world.getTileEntity(pos);
        playerEntity = player;
        this.playerInventory = new InvWrapper(playerInventory);
        layoutPlayerInventorySlots(8, 86);

        this.generator = (GoldMarketTile) tileEntity;

        this.te = (GoldMarketTile) world.getTileEntity(pos);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, ModBlocks.GOLD_MARKET.get());
    }
    ...
    {
        return this.te.getGoldPrice();
    }

    @OnlyIn(Dist.CLIENT)
    public int getGoldTime()
    {
        return this.te.getGoldTime();
    }
