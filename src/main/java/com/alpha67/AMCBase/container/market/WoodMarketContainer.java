...
public class WoodMarketContainer extends Container {
    private final TileEntity tileEntity;
    private final PlayerEntity playerEntity;
    private final IItemHandler playerInventory;
    public BlockPos BlockPos;

    public final WoodMarketTile generator;

    protected WoodMarketTile te;
    ...
    public WoodMarketContainer(int windowId, World world, BlockPos pos,
                               PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.WOOD_MARKET_CONTAINER.get(), windowId);
        this.tileEntity = world.getTileEntity(pos);
        playerEntity = player;
        this.playerInventory = new InvWrapper(playerInventory);
        layoutPlayerInventorySlots(8, 86);

        this.generator = (WoodMarketTile) tileEntity;

        this.te = (WoodMarketTile) world.getTileEntity(pos);
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, ModBlocks.WOOD_MARKET.get());
    }
    ...
    {
        return this.te.getWoodPrice();
    }

    @OnlyIn(Dist.CLIENT)
    public int getWoodTime()
    {
        return this.te.getWoodTime();
    }
