...
public class CoalGeneratorContainer extends Container {
    ...
    protected CoalGeneratorTile te;
    public int x, y, z;

    public BlockPos BlockPos;

    public final CoalGeneratorTile generator;

    public CoalGeneratorContainer(int windowId, World world, BlockPos pos,
                                  PlayerInventory playerInventory, PlayerEntity player) {
        super(ModContainers.COAL_GENERATOR_CONTAINER.get(), windowId);
        this.tileEntity = world.getTileEntity(pos);
        this.generator = (CoalGeneratorTile) tileEntity;

        this.te = (CoalGeneratorTile) world.getTileEntity(pos);
        ...
        if(tileEntity != null) {
            tileEntity.getCapability(CapabilityItemHandler.ITEM_HANDLER_CAPABILITY).ifPresent(h -> {
                addSlot(new SlotItemHandler(h, 0, 84, 31));
                addSlot(new SlotItemHandler(h, 1, 84, 56));
            });
        }
    }
    ...
    public boolean canInteractWith(PlayerEntity playerIn) {
        return isWithinUsableDistance(IWorldPosCallable.of(tileEntity.getWorld(), tileEntity.getPos()),
                playerIn, ModBlocks.COAL_GENERATOR.get());
    }
