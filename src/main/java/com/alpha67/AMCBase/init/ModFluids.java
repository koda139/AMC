...
public class ModFluids {
    ...
    public static final DeferredRegister<Fluid> FLUIDS
            = DeferredRegister.create(ForgeRegistries.FLUIDS, AMCBase.MOD_ID);
    ...
    public static final RegistryObject<FlowingFluidBlock> OIL_BLOCK = ModBlocks.BLOCKS_TUTO.register("oil",
