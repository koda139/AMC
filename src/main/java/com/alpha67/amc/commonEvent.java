...
public class commonEvent {
    ...
    public void TickEvent(TickEvent.WorldTickEvent event)
    {
        ...
        if (event.phase == TickEvent.Phase.END) {
            ...
            if (world instanceof ServerWorld) {
                ...
                //((ServerWorld) world).getGameRules().getRule(GameRules.RULE_DAYLIGHT).set((false), ((ServerWorld) world).getServer());
    ...
    private static int isPm() {
        ...
        {
            ((ClientWorld.ClientWorldInfo) worldInfo).setDayTime(24000);
        }
        else if (worldInfo instanceof ServerWorldInfo)
        {
            ((ServerWorldInfo) worldInfo).setDayTime(24000);
        }
